...
#define TRAY_SETTINGS_COMMAND 11
#define TRAY_EXIT_COMMAND 12

extern "C" __declspec(dllexport) bool CreateTrayIcon(HWND hWnd, WCHAR* openMenuName, WCHAR* settingsMenuName, WCHAR* exitMenuName, WCHAR* description);
...
public:
    ...
    bool TrayIconInit(HWND hWnd, WCHAR* openMenuName, WCHAR* settingsMenuName, WCHAR* exitMenuName, WCHAR* description);
